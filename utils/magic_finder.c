// Based on code taken from http://chessprogramming.wikispaces.com/Looking+for+Magics
// by Tord Romstad
...
int main() {
  ...
  printf("const SMagic rookMagic[64] = {\n");
  ...
  printf("const SMagic bishopMagic[64] = {\n");
  for(square = 0; square < 64; square++)
  {
